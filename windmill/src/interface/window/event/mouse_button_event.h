...
namespace wm {
	...
	class WM_PUBLIC mouse_button_event: public event {
	private:
		mouse_button button;
		bool press;
		bool shift;
	...
	public:
		...
		mouse_button_event(const mouse_button button, const bool press, const bool shift, const bool ctrl, const bool alt, const bool super, const bool caps_lock, const bool num_lock);
