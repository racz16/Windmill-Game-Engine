...
#include "audio_source_state.h"
#include "audio_buffer.h"

namespace wm {

	class WM_PUBLIC audio_source {
	public:
		static ptr<audio_source> create();
		static key<audio_source> get_key();
		...
		virtual void set_forward(const glm::vec3& forward) = 0;
