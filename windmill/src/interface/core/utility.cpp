...
namespace wm {
	...
	std::vector<keyboard_button> utility::keyboard_buttons = {
	...
	std::vector<mouse_button> utility::mouse_buttons = {
	...
	std::vector<gamepad_axis> utility::gamepad_axes = {
	...
	std::vector<gamepad_button> utility::gamepad_buttons = {
